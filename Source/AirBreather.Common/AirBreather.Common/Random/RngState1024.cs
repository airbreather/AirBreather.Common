...
namespace AirBreather.Common.Random
{
    public struct RngState1024 : IEquatable<RngState1024>, IRandomGeneratorState
    {
        ...
        public static string ToString(RngState1024 state) => FormattableString.Invariant($"{nameof(RngState1024)}[S0 = {state.s0}, S1 = {state.s1}, S2 = {state.s2}, S3 = {state.s3}, S4 = {state.s4}, S5 = {state.s5}, S6 = {state.s6}, S7 = {state.s7}, S8 = {state.s8}, S9 = {state.s9}, S10 = {state.s10}, S11 = {state.s11}, S12 = {state.s12}, S13 = {state.s13}, S14 = {state.s14}, S15 = {state.s15}, P = {state.p}]");
