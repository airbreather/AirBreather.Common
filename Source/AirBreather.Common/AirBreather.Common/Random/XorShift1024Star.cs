...
namespace AirBreather.Common.Random
{
    public struct XorShift1024StarState : IEquatable<XorShift1024StarState>, IRandomGeneratorState
    {
        ...
        public XorShift1024StarState(ulong s0, ulong s1, ulong s2, ulong s3, ulong s4, ulong s5, ulong s6, ulong s7, ulong s8, ulong s9, ulong s10, ulong s11, ulong s12, ulong s13, ulong s14, ulong s15, int p)
        {
            if (s0 == 0 && s1 == 0 && s2 == 0 && s3 == 0 && s4 == 0 && s5 == 0 && s6 == 0 && s7 == 0 && s8 == 0 && s9 == 0 && s10 == 0 && s11 == 0 && s12 == 0 && s13 == 0 && s14 == 0 && s15 == 0)
            {
        ...
        public bool IsValid => 0 <= p && p < 16 && (s0 != 0 || s1 != 0 || s2 != 0 || s3 != 0 || s4 != 0 || s5 != 0 || s6 != 0 || s7 != 0 || s8 != 0 || s9 != 0 || s10 != 0 || s11 != 0 || s12 != 0 || s13 != 0 || s14 != 0 || s15 != 0);
        public ulong S0 => this.s0;
        public ulong S1 => this.s1;
        public ulong S2 => this.s2;
        public ulong S3 => this.s3;
        public ulong S4 => this.s4;
        public ulong S5 => this.s5;
        public ulong S6 => this.s6;
        public ulong S7 => this.s7;
        public ulong S8 => this.s8;
        public ulong S9 => this.s9;
        public ulong S10 => this.s10;
        public ulong S11 => this.s11;
        public ulong S12 => this.s12;
